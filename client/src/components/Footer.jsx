...
const Footer = () => {
    return (
        <div className='bg-[#F6F9FC] text-gray-500/80 pt-20 px-6 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">TechSandeep</a>. All rights reserved.</p>
