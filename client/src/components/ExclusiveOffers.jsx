    ...
    return (
        ...
        pt-20 pb-30'>
            ...
            w-full'>
                ...
                subTitle='Take advantage of oour limited-time offers and special packages to enhance your
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
                {exclusiveOffers.map((item) => (
                    ...
                    justify-between gap-1 pt-16 md:pt-18 px-4 rounded-xl text-white
