        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='mt-25 space-y-4'>
                ...
                <p>Guests will be allocated on the ground floor according to availability.
                    ...
                    quoted is for two guest, at the guest slot please mark the number of guests to 
                    get the exact price for groups. The Guests will be allocated ground floor according to availability.
                ...
                <div className='flex flex-col items-start gap-4'>
                    <div className='flex gap-4'>
                        <img src={assets.starIconFilled} alt="Host" 
